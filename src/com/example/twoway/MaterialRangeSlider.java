...
public class MaterialRangeSlider extends View {
    ...
    private Set<Integer> isTouchingMinTarget = new HashSet<Integer>();
    private Set<Integer> isTouchingMaxTarget = new HashSet<Integer>();
    private int min = 0;
    ...
    private void getDefaultColors() {
    	colorControlNormal = Color.parseColor("#009CDE");
		colorControlHighlight = Color.parseColor("#009CDE");
